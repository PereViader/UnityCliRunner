...
namespace UnityLeanMcp
{
    internal class ExecuteMethodHandler : ICommandHandler
    {
        ...
        public void Handle(string payload, StreamWriter writer)
        {
            ...
            var begin = UnityLeanMcpOperationStore.TryBegin(operationId, OperationKinds.Execute, OperationStatus.Executing, out var existing);
        ...
        public static void ExecuteMethod(string operationId, MethodInfo method, string[] stringParams)
        {
            ...
            Debug.Log($"UnityLeanMcp: Executing method '{method.DeclaringType.FullName}.{method.Name}'...");
            ...
            OperationExecutionEngine.Execute(
                ...
                {
                    Debug.LogError($"UnityLeanMcp: Method execution failed: {ex}");
                }
            );
        }
